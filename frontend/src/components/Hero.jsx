  ...
  return (
    <section className=" pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        <div className="inline-flex items-center space-x-2 px-4 py-2 bg-[var(--badge-bg)] backdrop-blur-sm rounded-full text-[var(--text-on-primary)] text-sm mb-3">
        </div>
        ...
        <p className="text-xl md:text-2xl text-[var(--hero-text-muted)] mb-10 max-w-3xl mx-auto">
         Backend engineer intern at Sleepy Hollow Design. Class of 2027 Software Engineering at St. Leo University School of Computing, Artificial Intelligence, Robotics, and Data Science. UFC fan and metal guitarist.  
        </p>
